...
public class LoginController {
    ...
    public R sendCode(@RequestParam("mobile") String mobile) {
        ...
        stringRedisTemplate.opsForValue().set(AuthServerConstant.SMS_CODE_CACHE_PREFIX+mobile,
                redisStorage,10, TimeUnit.DAYS);

        thirdPartFeignService.sendCode(mobile, codeNum);
